...
public class ExampleMod implements ModInitializer {
	...
	public static final ScreenHandlerType<?> SCREEN_HANDLER_TYPE = ScreenHandlerRegistry.registerSimple(
			new Identifier("example", "drawer_block"), (syncId, inventory) ->
					new ExampleGuiDescription(syncId, inventory, ScreenHandlerContext.EMPTY));;
	...
	public void onInitialize() {
		...
		ScreenRegistry.<ExampleGuiDescription, ExampleBlockScreen>register(ExampleMod.SCREEN_HANDLER_TYPE, (gui, inventory, title) -> new ExampleBlockScreen(gui, inventory.player, title));
